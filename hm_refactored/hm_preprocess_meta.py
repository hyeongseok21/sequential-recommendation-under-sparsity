...
def hm_prep_meta(config):
    ...
    target_columns = ['user_id', 'item_id', 'age', 'price', 'timestamp', 'week', 'count', 'occurence', 'product_code', 'product_type_no', 'graphical_appearance_no',
                      'colour_group_code', 'perceived_colour_value_id', 'perceived_colour_master_id', 'department_no', 'index_group_no', 'section_no', 'garment_group_no']
    ...
    combined_user_ids = pd.concat([copy.deepcopy(train_df['user_id']), unique_last_test_df['user_id']], ignore_index=True).astype('category')
    combined_item_ids = pd.concat([copy.deepcopy(train_df['item_id']), unique_last_test_df['item_id']], ignore_index=True).astype('category')
    combined_prodct_code_ids = pd.concat([copy.deepcopy(train_df['product_code']), unique_last_test_df['product_code']], ignore_index=True).astype('category')
    combined_prodct_type_ids = pd.concat([copy.deepcopy(train_df['product_type_no']), unique_last_test_df['product_type_no']], ignore_index=True).astype('category')
    combined_graphical_appearance_ids = pd.concat([copy.deepcopy(train_df['graphical_appearance_no']), unique_last_test_df['graphical_appearance_no']], ignore_index=True).astype('category')
    combined_colour_group_code_ids = pd.concat([copy.deepcopy(train_df['colour_group_code']), unique_last_test_df['colour_group_code']], ignore_index=True).astype('category')
    combined_perceived_colour_value_ids = pd.concat([copy.deepcopy(train_df['perceived_colour_value_id']), unique_last_test_df['perceived_colour_value_id']], ignore_index=True).astype('category')
    combined_perceived_colour_master_ids = pd.concat([copy.deepcopy(train_df['perceived_colour_master_id']), unique_last_test_df['perceived_colour_master_id']], ignore_index=True).astype('category')
    combined_department_ids = pd.concat([copy.deepcopy(train_df['department_no']), unique_last_test_df['department_no']], ignore_index=True).astype('category')
    combined_index_group_ids = pd.concat([copy.deepcopy(train_df['index_group_no']), unique_last_test_df['index_group_no']], ignore_index=True).astype('category')
    combined_section_ids = pd.concat([copy.deepcopy(train_df['section_no']), unique_last_test_df['section_no']], ignore_index=True).astype('category')
    combined_garment_group_ids = pd.concat([copy.deepcopy(train_df['garment_group_no']), unique_last_test_df['garment_group_no']], ignore_index=True).astype('category')
    combined_age_ids = pd.concat([copy.deepcopy(train_df['age']), unique_last_test_df['age']], ignore_index=True).astype('category')
